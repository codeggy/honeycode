...
**¿Qué es?**
Contenedor IoC (Inversión de Control) central de Spring que gestiona el ciclo de vida de los beans.
...
**¿Qué es?**
Dos interfaces para el contenedor IoC de Spring con diferentes capacidades.
...
**¿Qué es?**
Anotación que indica a Spring que debe inyectar una dependencia automáticamente.
...
**¿Qué es?**
Anotación que especifica cuál bean inyectar cuando hay múltiples candidatos del mismo tipo.

**¿Cuándo usarlo?**
Cuando tienes varias implementaciones de una interfaz y necesitas elegir una específica.
...
**¿Qué es?**
Anotación que marca un bean como preferido cuando hay múltiples candidatos del mismo tipo.
...
**¿Qué es?**
Anotación para inyectar valores de configuración directamente en campos.
...
**¿Qué es?**
Anotación que mapea propiedades de configuración a un objeto Java tipado.
...
**¿Qué es?**
Secuencia de fases por las que pasa un bean desde su creación hasta su destrucción.
...
**¿Qué es?**
Anotación que retrasa la creación del bean hasta que se use por primera vez.
...
**¿Qué es?**
Anotación que activa beans solo en ciertos perfiles de ejecución.
...
**¿Qué es?**
Anotación que crea beans condicionalmente según ciertas condiciones.
...
**¿Qué es?**
Programación Orientada a Aspectos - paradigma que separa concerns transversales del código de negocio.
...
**¿Qué es?**
Anotación que habilita el soporte de AOP con AspectJ en Spring.
...
**¿Qué es?**
Anotación para ejecutar métodos periódicamente.
...
**¿Qué es?**
Secuencia de pasos que sigue una petición HTTP en Spring MVC.
...
**¿Qué es?**
Anotación que mapea URLs a métodos del controlador.
...
**¿Qué es?**
Dos formas de extraer datos de la URL.

**Diferencias:**
- **@PathVariable**: Extrae de la ruta (`/usuarios/{id}` → `id`)
- **@RequestParam**: Extrae query params (`?nombre=Juan` → `nombre`)
...
**¿Qué es?**
Anotaciones para conversión automática entre JSON y objetos Java.
...
**¿Qué es?**
Wrapper que representa una respuesta HTTP completa (status, headers, body).
...
**¿Qué es?**
Mecanismo para validar objetos usando Bean Validation (JSR 380).
...
**¿Qué es?**
Componente que intercepta requests antes y después del controlador.
...
**¿Qué es?**
Dos mecanismos para interceptar requests con diferentes niveles de acceso.
...
**¿Qué es?**
Cross-Origin Resource Sharing - mecanismo de seguridad del navegador para requests entre dominios.
...
**¿Qué es?**
Mecanismo para retornar diferentes formatos según lo que el cliente solicite.

**¿Cómo funciona?**
El cliente envía header `Accept` indicando el formato deseado (JSON, XML, etc.).
...
**¿Qué es?**
Interface de Spring Data JPA que proporciona operaciones CRUD y más.
...
**¿Qué es?**
Spring Data genera queries automáticamente a partir del nombre del método.
...
**¿Qué es?**
Anotación para definir queries JPQL o SQL nativo personalizadas.
...
**¿Qué es?**
API para construir queries dinámicas con criterios combinables.
...
**¿Qué es?**
Mecanismos para dividir y ordenar resultados de queries.
...
**¿Qué es?**
Anotación que define qué relaciones cargar junto con la entidad.
...
**¿Qué es?**
Funcionalidad que registra automáticamente quién y cuándo creó/modificó entidades.
...
**¿Qué es?**
Mecanismo para retornar solo campos específicos en vez de la entidad completa.
...
**¿Qué es?**
Atributo que define cómo se comporta una transacción cuando ya existe otra.
...
**¿Qué es?**
Atributo que define el nivel de aislamiento entre transacciones concurrentes.
...
**¿Qué es?**
Proceso de verificación de identidad del usuario.
...
**¿Qué es?**
Interface para cargar datos del usuario desde la base de datos.

**Método a implementar:** `loadUserByUsername(String username)`

**¿Para qué sirve?**
Conectar Spring Security con tu sistema de usuarios personalizado.
...
**¿Qué es?**
JSON Web Token - estándar para autenticación stateless.
...
**¿Qué es?**
Anotaciones para seguridad a nivel de método.
...
**¿Qué es?**
Protocolo de autorización para login con proveedores externos.
...
**¿Qué es?**
Cross-Site Request Forgery - ataque donde un sitio malicioso hace requests en nombre del usuario.
...
**¿Qué es?**
Formas de acceder a los datos del usuario actualmente autenticado.
...
**¿Qué es?**
Interface para encriptar y verificar passwords de forma segura.
...
**¿Qué es?**
Configurar autorización basada en roles para diferentes endpoints.
...
**¿Qué es?**
Objeto que almacena el `Authentication` del usuario actual.
...
**¿Qué es?**
Tests de integración para la capa web.
...
**¿Qué es?**
Tests unitarios para la capa de lógica de negocio.
...
**¿Qué es?**
Anotación que carga el contexto completo de Spring para tests de integración.
...
**¿Qué es?**
Librería para ejecutar contenedores Docker en tests.
